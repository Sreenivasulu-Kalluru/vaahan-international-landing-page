        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              At Vaahan, we believe the vehicle of tomorrow is defined by the
              software it runs today. We are transitioning the automotive
              industry from hardware-centric to software-defined, creating a
              seamless integration between human, machine, and the digital
              ecosystem.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-12 p-8 bg-muted/30 rounded-3xl border border-border/50">
              ...
              <div className="flex flex-col gap-2">
                <h4 className="text-5xl font-extrabold text-primary">
                  500<span className="text-2xl">M+</span>
                </h4>
                <p className="text-sm font-medium text-foreground">
                  Miles Driven by Our Tech
                </p>
              </div>
            </div>
          </motion.div>
